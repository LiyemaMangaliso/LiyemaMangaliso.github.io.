...
ICT: Application Development (Diploma/Degree in Progress)  
- Completed Year 2: 2025  
- 2026 – Final Year (Present)  
...
- Designed and developed functional desktop system using Java  
- Applied OOP principles (encapsulation, inheritance, polymorphism)  
- Implemented event-driven programming and error handling  

### Takealot UI/UX Evaluation & Redesign
- Conducted usability analysis using Material Design principles  
...
### Part-Time Event Assistant – 2025
- Coordinated logistics and supported event operations  
- Managed registrations and guest flow  
- Demonstrated communication and teamwork  

### Event Staff – VIP & Media Relations (MOM Spotify Support Crew) – 2024
- Managed VIP and media coordination  
- Demonstrated organization and professional communication  
